package com.app.vutestapplication.services.with_annotations;
...
public class RetryCallAdapterFactory extends CallAdapter.Factory {
    ...
    static final class RetryCallAdapter<R, T> implements CallAdapter<R, T> {
        ...
        RetryCallAdapter(CallAdapter<R, T> delegated, int maxRetries) {
    ...
    static final class RetryingCall<R> implements Call<R> {
        ...
        RetryingCall(Call<R> delegated, int maxRetries) {
            this.delegated = delegated;
            this.maxRetries = maxRetries;
        }
        @Override
    ...
    static final class RetryCallback<T> implements Callback<T> {
        ...
        private final int maxRetries;
        RetryCallback(Call<T> call, Callback<T> callback, int maxRetries) {
            this.call = call;
